...
function plot_greenlee_electrodes_on_brain(electrode_table_indices, color_values, ops)
...
surf_show('SURFACE_ADD', ops.base_surfaces,... % base surfaces
    'SURFACE_ADD', ops.tempfile, 'SURFACE_PROPERTIES','color',rgbvals, 'RESOLUTION', surfshow_resolution); % colored electrode locations
