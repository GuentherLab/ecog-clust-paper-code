...
plotops.font =  'Arial';
plotops.fig_x_y_width_length =  [50 150 900 600]; % y coord may have to be changed per computer
...
plotops.inner_position = [0.1300 0.1200 0.7750 0.8150]; % adjust if axis labels are getting clipped
plotops.yticks = [0:.25:1]; 
plotops.ylabel_position = [-0.4 0.4 0.5];
plotops.background_color =  [1 1 1]; 

plotops.legend_position = [0.78 0.8 0.25 0.178]; % x,y,width,height
...
hax.PositionConstraint = 'innerposition';
...
hleg = legend({'consonant','vowel','syllable'}); 
    ...
    hleg.FontSize = plotops.leg_fontsize; 
