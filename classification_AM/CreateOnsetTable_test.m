...
save_path = '/projectnb/busplab/Experiments/ECoG_Preprocessed_AM'; 

add_str = ''; 
% add_str = '_sess01_'; %%% this string must be added for S362; scott analyzed the first, not the second session for this subject
...
save_file = fullfile(save_path, 'LocalProcessed', sub_str, ['LocalOnsetTable' sess_str '.mat']);
