...
function sub_indiv_elect_cv_mRMR_LDA_OvR_data = indiv_electrode_cv_mRMR_LDA_OvR_rand(params, class_label)
...
for sub_num_idx = 1:length(sub_nums)
    ...
    fprintf('Processing stimulus data for subject %s... ', sub_str);
    ...
    class_labels_ohe = stim_e_feat_class.stim_feat_class{sub_num_idx}.class_labels_ohe;
    class_labels_ohe = class_labels_ohe(randperm(height(class_labels_ohe)), :);
    ...
    fprintf('Done. \n\nNow processing onset data for subject %s... ', sub_str);
